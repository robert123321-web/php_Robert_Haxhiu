...
<body class="text-center">
    <main class = "form-signin">
        <form action="register.php" method="post">
            <img class="mb-4"    src="nike-4-logo-black-and-white.png" alt="" width="72" height="57">
            ...
            <div class="form-floating">
                <input type="pasword" class="form-control"  id="floatingInput"
                placeholder="Password"  name="password">
                <label for="floatingInput">Paasword</label>

            </div>
            <div class="form-floating">
                <input type="pasword" class="form-control"  id="floatingInput"
                placeholder="passord"  name="email">
